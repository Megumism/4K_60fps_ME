...
insert_pad_filler -cell {HPFILLER5A HPFILLER1A HPFILLER05A HPFILLER01A HPFILLER0005A}
...
##	i.   Press the key "m"
##	ii.  Select the macro (Click the left mouse bottom)
##	iii. Move the macro (Click the left mouse bottom --> move)
##  2. Or, you can use commands to move a macro
##	#move_objects -to {x y} collection
	move_objects -to {128 190} [get_cells inst_idct/ram8x8_1/mem]
	move_objects -to {128 130} [get_cells inst_idct/ram8x8_2/mem]
...
analyze_fp_rail -nets {VDD VSS} -voltage_supply 1.0 -pad_masters {HPVDD1DGP HPVSS1DGP}
