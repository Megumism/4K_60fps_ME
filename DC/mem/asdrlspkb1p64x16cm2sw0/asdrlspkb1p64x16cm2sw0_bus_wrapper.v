...
module asdrlspkb1p64x16cm2sw0_wrapper (Q ,ADR ,D ,WE ,ME ,CLK );
...
asdrlspkb1p64x16cm2sw0 u_mem (  .Q(Q), .ADR(ADR), .D(D), .WE(WE), .ME(ME), .CLK(CLK), .TEST1(1'b0), .RM(4'b0010), .RME(1'b0));
